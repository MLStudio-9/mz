...
def monitor_packet(packet):
    """Мониторит пакет и обновляет трафик для источника и получателя."""
...
def block_ip(ip):
    """Блокирует IP-адрес с помощью iptables, если root-права позволяют это."""
...
def check_traffic_limits():
    """Проверяет трафик для каждого IP и блокирует, если превышен лимит."""
