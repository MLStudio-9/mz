# Данный бот делался от знаменитого хорошего парня ZoxDev
import sys
import telebot
import sqlite3
import time
...
bot = telebot.TeleBot('7758153088:AAGI1hzzpQT8MFVj2H3CapybS3-ihEWb3Q0')  # Замените на ваш API ключ
...
def start(message):
    response = (
        'Добро пожаловать в бота Zox Brawl!\n\n'
        'TG: @arhivebrawl\n\n'
        '⛔Команды:\n\n'
